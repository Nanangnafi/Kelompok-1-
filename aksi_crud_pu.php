...
if (isset($_POST['bsimpan'])) {
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO pendaftaran_ujian_kp (laporan_kp,jadwal_ujian)
...
if (isset($_POST['bubah'])) {
    ...
    $ubah = mysqli_query($koneksi, "UPDATE pendaftaran_ujian_kp SET laporan_kp = '$_POST[tlaporan_kp]',
...
if (isset($_POST['bhapus'])) {
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM pendaftaran_ujian_kp WHERE id = '$_POST[id]' ");

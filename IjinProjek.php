...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="aksi_izin.php">
            <br>
            <h2 class="alert alert-primary text-center mt-3">Ijin KP</h2><br>

            <form>
                <div class="mb-3">
                    <label>Id</label>
                    <input type="text" name="tid" class="form-control" placeholder="Masukkan Id Anda">
                </div>

                <div class="mb-3">
                    <label>Nama Lengkap</label>
                    <input type="text" name="tnama_lengkap" class="form-control" placeholder="Masukkan Nama Lengkap Anda">
                </div>

                <div class="mb-3">
                    <label>Surat Ijin</label>
                    <input type="file" name="tsurat_ijin" class="form-control" placeholder="Masukkan File Anda">
                </div>
